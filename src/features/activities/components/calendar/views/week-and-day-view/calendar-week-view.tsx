...
import { DroppableArea } from '@/features/activities/components/calendar/dnd/droppable-area'
import { groupEvents } from '@/features/activities/components/calendar/helpers'
import type { IEvent } from '@/features/activities/components/calendar/interfaces'
import { CalendarTimeline } from '@/features/activities/components/calendar/views/week-and-day-view/calendar-time-line'
import { RenderGroupedEvents } from '@/features/activities/components/calendar/views/week-and-day-view/render-grouped-events'
import { WeekViewMultiDayEventsRow } from '@/features/activities/components/calendar/views/week-and-day-view/week-view-multi-day-events-row'
                ...
                {weekDays.map((day, dayIndex) => {
                  const dayEvents = singleDayEvents.filter(
                    (event) =>
                      ...
                      isSameDay(parseISO(event.endTime), day)
                  )
