...
import { EventDetailsDialog } from '@/features/activities/components/calendar/dialogs/event-details-dialog'
import { DraggableEvent } from '@/features/activities/components/calendar/dnd/draggable-event'
      ...
      <EventDetailsDialog event={event}>
        <div role='button' tabIndex={0} className={eventBadgeClasses}>
          ...
          <div className='hidden sm:block'>
            {renderBadgeTime && (
              <span>
                {formatTime(new Date(event.startTime), use24HourFormat)}
              </span>
            )}
          </div>
        </div>
