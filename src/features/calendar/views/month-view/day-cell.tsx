...
import { isToday, startOfDay, isSameMonth } from 'date-fns'
    ...
    () => (
      <motion.div
        className={cn(
          ...
          // Remove left border for Monday (first column in week starting Monday)
          date.getDay() === 1 && 'border-l-0'
        )}
              ...
              <div className='group flex h-full w-full items-center justify-center'>
                <AddEditEventDialog startDate={date}>
                  ...
                  >
                    ...
                    <span className='max-sm:hidden'>Thêm hoạt động</span>
                  </Button>
                </AddEditEventDialog>
              </div>
            ) : (
